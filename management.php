      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="management.php" class="nav-link  active">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Project Management Data table</h3> 
                 <a href="updates.php"> <button type="button" class="btn btn-primary btn-sm" style="margin-left: 58%"><i class="fa fa-arrow-left"> Project Updates</i>
                </button></a>
                              ...
                              <div class="card-body">
                               ...
                               <div class="col-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" id="" placeholder="Enter Project Code ..">
                                </div>
                                </div>
                                 <div class="col-6">
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Banner</label>
                                  <input type="text" class="form-control" id="" placeholder="Enter Project Banner ..">
                                </div>
                                </div>
