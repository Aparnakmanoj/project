...
<center><h1> CHECK YOUR PROJECT STATUS</h1>
<?php

$q=mysqli_query($conn,"select * from tbl_topic where stid='$stid'");// use session
$res=mysqli_fetch_array($q);
if($res[3]== 0)
{
	echo 'Your project topic is not validated by your guide plzzzz wait for the response';
}
if($res[3]== 2)
{
	echo 'Sorry !!!!!!!!!! your project topic rejected plss try with another topic all the best';
    
	?>
	</br></br></br></br>
	<?php echo "<a href='resub.php?id=$stid'>PLZZ SUBMIT NEW TOPIC</a>";
	
}

if($res[3]== 1)
{
	echo 'Congratulations!!!!!!!!!! your project topic approved plss upload the documents now***********';
	?>
	</br></br></br>
	
	<?php echo "<a href='documentsub.php?id=$stid'>UPLOAD Document</a>";?>
	<?php
}}}
?>
</form>
