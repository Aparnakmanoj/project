      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <a href="memberassignment.php" class="nav-link active">
              <i class="nav-icon fas fa-book"></i>
              <p>
                Member Assignment
              </p>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Member Assignment</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Project Member Assignment Data table</h3> 
                
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add" style="margin-left: 66%"><i class="fa fa-plus">Add</i>
                </button>
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <select class="form-control">
                                 ...
                                 <div class="col-12">
                                <div class="form-group">
                                  <label for="exampleInputPassword1">Task Info</label>
