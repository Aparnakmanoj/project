...
<form name="form1" method="post" action="teem5.php">

<label>ENTER NUMBER OF STUDENTS IN A TEAM</label>
<input name="t1" type="text"  class="form-control" value="<?php if(isset($no_of_std)) echo $no_of_std ;  else $no_of_std='0';?>" place holder="select no" required>
</br>
<label>SELECT GUIDE</label>
 <select name="select1" class="form-control">
		...
		<?php
			$data=mysqli_query($conn,"SELECT * FROM tbl_teachteg where tstatus='0'");
