  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
          <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">UPLOAD YOUR DOCUMENTS </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
{   
 ...
 $data=mysqli_query($conn,"select * from image where studid='$stid' and dtype='$doc'");
     $r1=mysqli_fetch_array($data);
     if(empty($r1[0]))
{
         //echo 'already uploaded';
 if(move_uploaded_file($file_loc,$folder.$final_file))
 {
  $sql="INSERT INTO image(studid,dtype,file,type,size,rstatus) VALUES('$stid','$doc','$final_file','$file_type','$new_size','0')";
...
<h5><label>SELECT DOCUMENT TYPE:</label>
<select name="select1">
    <H2>
