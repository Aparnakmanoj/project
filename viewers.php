                          ...
                          <div class="modal-content">
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <label>Viewers List</label>
                                 
      <?php   
    $sql = mysqli_query($conn,"SELECT tbl_readstatus.stid,tbl_readstatus.remail,tbl_studreg.name,tbl_studreg.lname,tbl_studreg.email
FROM tbl_studreg
INNER JOIN tbl_readstatus ON tbl_readstatus.remail=tbl_studreg.email and tbl_readstatus.nid=$noid;");
  ...
  ?>
    <br><?php echo $row['name']." ".$row['lname'];
  }?>
                              </div>
                                </div>
