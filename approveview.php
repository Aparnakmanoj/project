...
if($getid!=0)
{
  ...
  $q="select count(*) as c from tbl_login where status = 0 and utype = 3 ";
          ...
          <div class="col-sm-6">
           ...
           <div class="card-body">
             ...
             <div class="form-group">
                  ...
                  <tbody>
                  <?php
                       $qu="select * from tbl_studreg where status= 2 ";
                       ...
                       if($res)
                     {
                        while($row1=mysqli_fetch_assoc($res))
                          ...
                          <td>'.$phone.'</td> 
                           <td>
                               <button  type="button" class="btn btn-outline-success"><a href="approveuser.php?accept='.$email.'">Send Mail</a></button>
